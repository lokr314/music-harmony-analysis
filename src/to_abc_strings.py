...
def analysis_to_abc_strings(analysis, harmony_lines, mode='pac', custom_pitch_to_abc_method=None):
    ...
    for line in analysis_lines:
        ...
        for x in line: # x = (event, harmonic_state, sauterian_formula, degree_of_dissonance_or_atonal)
            ...
            sauterian_formula_string += sauterian_formula_to_abc_string(x[2]) + '~ '
            degree_of_dissonance_or_atonal_string += x[3] + '~ '
        ...
        output["events"].append(event_string)
        output["harmonic_states"].append(harmonic_states_string)
        output["sauterian_formula"].append(sauterian_formula_string)
        output["degree_of_dissonance_or_atonal"].append(degree_of_dissonance_or_atonal_string)
...
def to_abc_strings_preprocess(analysis, harmony_lines):
    ...
    while True:
        ...
        current_line.append((event, harmonic_state, sauterian_formula, degree_of_dissonance_or_atonal))
